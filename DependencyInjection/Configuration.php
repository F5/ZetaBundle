...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('zeta');

        $rootNode
            ->children()
                ->arrayNode("search")
                ->children()
                    ->scalarNode("handler")->defaultValue("zeta.search.handler.solr")->end()
                    ->scalarNode("manager")->defaultValue("zeta.search.manager.embedded")->end()
